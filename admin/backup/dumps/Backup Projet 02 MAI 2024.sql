...
-- Started on 2024-05-02 11:23:43
...
INSERT INTO public.ti_detailpanier (id_detailpanier, fk_panier, fk_produit) VALUES (29, 43, 10);
...
INSERT INTO public.ti_panier (id_panier, client) VALUES (43, 21);
...
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (2, 'GPU RTX 3080', 'Carte graphique gaming de pointe, 10 Go de mémoire GDDR6X, fréquence boost jusqu''à 1710 MHz', 1200, 5);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (3, 'SSD Samsung 1To
', 'Disque SSD haute vitesse, lecture jusqu''à 550 Mo/s, écriture jusqu''à 520 Mo/s', 150, 9);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (4, 'RAM DDR4 16Go', 'Module de mémoire DDR4 16 Go, fréquence 3200 MHz, idéal pour les configurations gaming et multitâches', 120, 10);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (5, 'Carte mère Asus Z590', 'Carte mère avec chipset Z590, supporte les derniers processeurs Intel, USB 3.2 Gen 2, PCIe 4.0', 250, 8);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (1, 'CPU Intel Core I7', 'Processeur Intel Core i7 : 
Processeur hautes performances pour les tâches multitâches, fréquence 3.5 GHz, 8 cœurs', 350, 4);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (6, 'CPU Intel Core I3', 'Processeur Intel Core I3
', 70, 4);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (7, 'CPU AMD Ryzen 5 ', 'Processeur AMD Ryzen 5 5500 (3.6GHz)
', 113, 4);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (8, 'CPU Intel Core I5', 'Processeur Intel Core I5-12400F (2.5Ghz)', 120, 4);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (9, 'GPU RTX 4070', 'Carte graphique - Refroidissement semi-passif (mode 0 dB) - 12 Go GDDR6X / Alimentation PC Certifiée 80+ Gold - Modulaire - ATX 3.0', 700, 5);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (10, 'ASUS Vivobook S15', 'Ordinateur Portable 15.6" Full HD - AMD Ryzen 5 7250U - 8 Go DDR5 - SSD 512 Go - Windows 11', 550, 1);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (11, 'PC Work Bronze Pro Intel', 'PC FIXE Intel Core i5-12400 - 16 Go DDR4 - SSD 1 To PCIe 4.0 - WiFi - Windows 11', 660, 2);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (12, 'PC Gamer Delta ', 'PC Gamer AMD Ryzen 5 7500F - Radeon RX 7600 XT - 16 Go DDR5 - SSD 1 To PCIe 4.0 - WiFi - Windows 11', 1300, 3);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (13, 'Corsair 4000D Airflow - Noir', 'Boitier PC Moyen Tour - E-ATX / ATX / mATX / Mini-ITX - USB 3.1 Type C - Avec fenêtre (pleine taille)', 100, 6);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (14, 'Fox Spirit HG850 - 850W', 'Alimentation PC Certifiée 80+ Gold - Modulaire - ATX 3.0', 120, 7);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (15, 'Fox Spirit Cold Snap VT120 Black V2', 'Ventirad Tour - PWM - Socket AMD AM5 / AM4 et Intel 115x / 1200 / 1700', 34, 11);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (19, 'GTX 1060', 'carte graphique nvidia', 100, 5);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (20, 'GTX 1060', 'carte graphique nvidia', 100, 5);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (21, 'azdodjkaz', 'adzopdkzapo', 200, 11);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (22, 'azdodjkaz', 'adzopdkzapo', 200, 11);
INSERT INTO public.ti_produits (id_produit, nom, description, prix, categorie) OVERRIDING SYSTEM VALUE VALUES (23, 'amd ryzen 3 ', 'processeur amd', 200, 4);
...
SELECT pg_catalog.setval('public."TI_Produits_id_produit_seq"', 23, true);
...
SELECT pg_catalog.setval('public.ti_detailpanier_id_detailpanier_seq', 29, true);
...
SELECT pg_catalog.setval('public.ti_panier_id_panier_seq', 43, true);
...
-- Completed on 2024-05-02 11:23:43
